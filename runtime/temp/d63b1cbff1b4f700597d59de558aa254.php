<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"H:\wj\study\thinkphp5\rbac\public/../application/index\view\role\access.html";i:1542385413;s:61:"H:\wj\study\thinkphp5\rbac\application\index\view\layout.html";i:1542299776;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container-fluid">
    ...
    <div class="col-xs-9 col-sm-9 col-md-9  col-lg-9">
        <h5>为 <?php echo $info['name']; ?> 设置权限</h5>
    </div>
</div>
<hr/>
<div class="row">
    <div class="form-horizontal role_access_set_wrap" role="form">
        <div class="form-group">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <?php if($access_list): foreach($access_list as $v): ?>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="access_ids[]" value="<?php echo $v['id']; ?>" <?php if(in_array($v['id'],$role_access_id)): ?>checked<?php endif; ?>>
                        <?php echo $v['title']; ?>
                    </label>
                </div>
...
<script type="text/javascript" src="/static/js/role/access.js"></script>
        <footer>
