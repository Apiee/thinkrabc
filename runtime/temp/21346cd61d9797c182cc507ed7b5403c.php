<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"H:\wj\study\thinkphp5\rbac\public/../application/index\view\user\set.html";i:1542287456;s:61:"H:\wj\study\thinkphp5\rbac\application\index\view\layout.html";i:1542299776;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="row">
    <div class="form-horizontal user_set_wrap" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <?php if($role_list): foreach($role_list as $_role_item): ?>
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="role_ids[]" value="<?php echo $_role_item['id']; ?>"
                               <?php if(in_array($_role_item['id'],$related_role_ids)): ?>checked<?php endif; ?>>
                        <?php echo $_role_item['name']; ?>
                    </label>
                </div>
...
<script type="text/javascript" src="/static/js/user/set.js"></script>
        <footer>
