<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"H:\wj\study\thinkphp5\rbac\public/../application/index\view\role\index.html";i:1542372063;s:61:"H:\wj\study\thinkphp5\rbac\application\index\view\layout.html";i:1542299776;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container-fluid">
    ...
    <div class="col-xs-3 col-sm-3 col-md-3  col-lg-3">
        <a href="<?php echo url('role/set'); ?>" class="btn btn-link pull-right">添加角色</a>
    </div>
</div>
<hr/>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo url('role/access',['id'=>$vo['id']]); ?>">设置权限</a>
            </td>
        </tr>
