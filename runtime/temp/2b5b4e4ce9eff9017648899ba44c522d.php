<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"H:\wj\study\thinkphp5\rbac\public/../application/index\view\user\login.html";i:1539704810;s:61:"H:\wj\study\thinkphp5\rbac\application\index\view\layout.html";i:1542299776;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container-fluid">
    ...
    <div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 col-lg-10 col-lg-offset-2">
        <div>
    <p style="color: red;">请登录，本实例没有登录页面，请使用伪登录，地址：http://<?php echo \think\Request::instance()->server('http_host'); ?> /index/user/vlogin?uid=xxx(将xx换成user表中的id值)</p>
    <p>如果你user表中已有超级管理员信息，直接访问<a href="http://<?php echo \think\Request::instance()->server('HTTP_HOST'); ?>/index/user/vlogin?uid=1">http://<?php echo \think\Request::instance()->server('HTTP_HOST'); ?>/index/user/vlogin?uid=1</a>进行登录</p>
</div>
        <footer>
